...
public class ActiveDirectory {
    ...
    public static LdapContext getConnection(String username, String password, String domainName, String serverName) throws NamingException {
        ...
        try {
            ...
            throw new NamingException("LDAP: error code 52 - Failed to connect to " + domainName + ((serverName == null) ? "" : " through " + serverName));
        } catch (NamingException e) {
            throw new NamingException("LDAP: error code 49 - Failed to authenticate " + username + "@" + domainName + ((serverName == null) ? "" : " through " + serverName));
        }
    }
    ...
    public static class User {
        ...
        public void changeMail(String mail, boolean trustAllCerts, LdapContext context)throws java.io.IOException, NamingException {
            ...
            try {
                ...
                throw new java.io.IOException("LDAP: error code 52 - &Eacute;chec de l'&eacute;tablissement de la connexion SSL avec le contrôleur de domaine.");
            }
            ...
            try {
                ...
                modificationItems[0] = new ModificationItem(DirContext.REPLACE_ATTRIBUTE, new BasicAttribute("mail", mail));                
                ...
                throw new NamingException(
                        "LDAP: error code 21 - Format invalide pour l'annuaire Active Directory."
                        + "Assurez-vous que le courriel est conforme aux exigences"                        
                );
            } catch (NamingException e) {
                tls.close();
                throw e;
        ...
        public void changePassword(String oldPass, String newPass, boolean trustAllCerts, LdapContext context)
            ...
            try {
                ...
                tls.close();
                throw new NamingException(
                        "LDAP: error code 19 - 0000052D Votre mot de passe ne respecte pas les requis de l'annuaire Active Directory."
                        + "Assurez-vous que le nouveau mot de passe est conforme aux exigences en matière de complexit&eacute;, "
                        + "de longueur, d'âge minimum du mot de passe et d&apos;historique de mot de passe."
                );
            } catch (NamingException e) {
                tls.close();
                throw e;
